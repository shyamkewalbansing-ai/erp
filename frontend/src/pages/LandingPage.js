          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-8 lg:pr-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button size="lg" className="h-14 px-8 text-base bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 rounded-full shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 transition-all font-body font-semibold" onClick={() => navigate('/modules')} data-testid="hero-cta-primary">
                  Ontvang het pakket
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
                <Button size="lg" variant="outline" className="h-14 px-8 text-base border-2 border-emerald-200 text-emerald-700 hover:bg-emerald-50 rounded-full transition-all font-body font-medium" onClick={() => navigate('/modules')} data-testid="hero-cta-secondary">
                  Direct Bestellen
                </Button>
              </div>
