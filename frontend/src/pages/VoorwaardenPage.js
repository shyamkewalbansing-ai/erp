...
export default function VoorwaardenPage() {
  ...
  const loadData = async () => {
    try {
      ...
      const termsSection = sectionsRes.data.find(s => s.section_type === 'terms');
      setSection(termsSection);
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {section ? (
          ...
          <div className="text-center py-16">
            <h1 className="text-4xl font-bold text-foreground mb-4">Algemene Voorwaarden</h1>
