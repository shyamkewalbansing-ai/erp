...
export default function Layout() {
  ...
  return (
    <div className="app-container">
      ...
      {/* WhatsApp Button - Fixed right side middle */}
      <a
        href="https://wa.me/5978934982?text=Hallo%2C%20ik%20heb%20een%20vraag%20over%20Facturatie.sr"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed right-0 top-1/2 -translate-y-1/2 z-50 bg-[#25D366] hover:bg-[#128C7E] text-white p-3 rounded-l-xl shadow-lg transition-all duration-300 hover:pr-5 group"
