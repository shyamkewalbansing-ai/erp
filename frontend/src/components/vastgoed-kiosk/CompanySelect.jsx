        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.06)] border border-slate-100 w-full max-w-2xl p-10 md:p-14" data-testid="kiosk-login-card">
            ...
            <div className="space-y-4 mb-8">
              ...
              {/* Password + Face ID row */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  onClick={() => { resetForm(); setView('password'); }}
                  data-testid="kiosk-password-login-btn"
                  className="h-20 bg-white text-slate-800 border-2 border-slate-200 hover:border-[#FF5C00] hover:bg-orange-50 rounded-2xl flex items-center justify-center gap-3 text-lg md:text-xl font-semibold transition-all active:scale-[0.97]"
                >
                ...
                >
                  <ScanFace className="w-6 h-6 md:w-7 md:h-7 text-violet-600" />
                  Face ID
                </button>
              </div>
            </div>
