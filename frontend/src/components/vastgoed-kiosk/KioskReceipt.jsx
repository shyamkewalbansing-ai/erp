...
export default function KioskReceipt({ payment, tenant, companyId, onDone }) {
  ...
  return (
    <div className="kiosk-fullscreen flex">
      {/* Left Panel - Success */}
      <div className="w-1/2 bg-gradient-to-br from-emerald-600 to-emerald-700 flex flex-col items-center justify-center p-12 text-white relative overflow-hidden">
        {/* Decorative circles */}
        <div className="absolute -top-32 -left-32 w-96 h-96 bg-white/10 rounded-full" />
        <div className="absolute -bottom-48 -right-48 w-[500px] h-[500px] bg-emerald-500/30 rounded-full" />
        
        <div className="relative z-10 text-center">
          <CheckCircle className="w-40 h-40 mx-auto mb-8" />
          <h1 className="text-6xl font-bold mb-4">Betaling geslaagd!</h1>
          <p className="text-3xl text-emerald-100 mb-12">Kwitantie: {kwNr}</p>
          
          <div className="flex flex-col gap-4">
            <button
              onClick={handlePrint}
              className="kiosk-btn-xl bg-white text-emerald-600 hover:bg-emerald-50"
            >
            ...
            <button
              onClick={onDone}
              className="kiosk-btn-lg bg-emerald-500/30 hover:bg-emerald-500/50 text-white border-2 border-white/30"
            >
          ...
          <div className="mt-12">
            ...
            <p className="text-emerald-200 text-xl">Automatisch terug naar welkomscherm</p>
          </div>
        </div>
      </div>
