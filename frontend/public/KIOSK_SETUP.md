...
2. Plak dit:
```
"C:\Program Files\Google\Chrome\Application\chrome.exe" --kiosk --kiosk-printing "https://tenant-receipt-1.preview.emergentagent.com/vastgoed"
```
...
## Linux
```bash
chromium-browser --kiosk --kiosk-printing "https://tenant-receipt-1.preview.emergentagent.com/vastgoed"
```
