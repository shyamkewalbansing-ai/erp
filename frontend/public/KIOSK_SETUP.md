...
2. Plak dit:
```
"C:\Program Files\Google\Chrome\Application\chrome.exe" --kiosk --kiosk-printing "https://erp-kiosk-dev.preview.emergentagent.com/vastgoed"
```
...
## Linux
```bash
chromium-browser --kiosk --kiosk-printing "https://erp-kiosk-dev.preview.emergentagent.com/vastgoed"
```
