        ...
        async with httpx.AsyncClient() as client:
            response = await client.post(
                ...
                json={
                    ...
                    "redirect_url": "https://dashboard-redesign-44.preview.emergentagent.com/betaling-voltooid"
                },
                timeout=30.0
            )
...
# ============================================
# NOTE: HRM endpoints are now handled by routers/hrm.py
# which provides the full-featured HRM module with:
# - first_name/last_name support
# - Surinamese tax calculations
# - Automatic journal entries
# - All employee, department, leave, contract, payroll, attendance endpoints
