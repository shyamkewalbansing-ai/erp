...
class TestBeautySpaAuth:
    """Authentication for Beauty Spa tests"""
...
class TestBeautySpaDashboard(TestBeautySpaAuth):
...
class TestBeautySpaClients(TestBeautySpaAuth):
    """Client/CRM endpoint tests"""
    
    def test_list_clients(self, headers):
...
class TestBeautySpaTreatments(TestBeautySpaAuth):
    """Treatment endpoint tests"""
    
    def test_list_treatments(self, headers):
    ...
    def test_create_treatment(self, headers):
    ...
    def test_update_treatment(self, headers):
    ...
    def test_delete_treatment_soft(self, headers):
...
class TestBeautySpaStaff(TestBeautySpaAuth):
    ...
    def test_create_staff(self, headers):
    ...
    def test_update_staff(self, headers):
...
class TestBeautySpaProducts(TestBeautySpaAuth):
    """Product/Inventory endpoint tests"""
    ...
    def test_adjust_stock(self, headers):
...
class TestBeautySpaAppointments(TestBeautySpaAuth):
    """Appointment endpoint tests"""
    
    @pytest.fixture(scope="class")
    def test_data(self, headers):
        """Create test client, treatment, and staff for appointments"""
        # Create client
        ...
        return {"client_id": client_id, "treatment_id": treatment_id, "staff_id": staff_id}
    ...
    def test_create_appointment(self, headers, test_data):
        """Test creating a new appointment"""
        tomorrow = (datetime.now() + timedelta(days=1)).strftime("%Y-%m-%d")
        
        appointment_data = {
            "client_id": test_data["client_id"],
            "treatment_id": test_data["treatment_id"],
    ...
    def test_update_appointment(self, headers, test_data):
...
class TestBeautySpaPOS(TestBeautySpaAuth):
    """POS/Sales endpoint tests"""
    ...
    def test_create_sale(self, headers):
...
class TestBeautySpaQueue(TestBeautySpaAuth):
    """Walk-in Queue endpoint tests"""
    ...
    def test_add_to_queue(self, headers):
...
class TestBeautySpaVouchers(TestBeautySpaAuth):
    """Voucher endpoint tests"""
    
    def test_list_vouchers(self, headers):
    ...
    def test_create_voucher(self, headers):
    ...
    def test_delete_voucher(self, headers):
...
class TestBeautySpaReports(TestBeautySpaAuth):
    ...
    def test_treatments_report(self, headers):
    ...
    def test_products_report(self, headers):
    ...
    def test_staff_report(self, headers):
        """Test staff report"""
    ...
    def test_clients_report(self, headers):
        """Test clients report"""
...
def cleanup_test_data():
    ...
    yield
    # Note: In production, you would add cleanup logic here
    # For now, test data with TEST_ prefix can be manually cleaned
    print("\nTest session complete. TEST_ prefixed data may need manual cleanup.")
